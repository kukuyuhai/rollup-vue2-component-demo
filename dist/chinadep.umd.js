(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue-codemirror'), require('lodash'), require('vuex')) :
  typeof define === 'function' && define.amd ? define(['vue-codemirror', 'lodash', 'vuex'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.chinadep = factory(global["vue-codemirror"], global.lodash, global.vuex));
})(this, (function (vueCodemirror, _, vuex) { 'use strict';
    ...
    return _c(
      ...
      [
        _c("codemirror", {
          ref: "CodeMirror",
          staticClass: "editor",
          attrs: { value: _vm.code, options: _vm.mergeOptions },
  ...
  __vue_render__$6._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__$6 = "data-v-8623d7ce";
    /* module identifier */
  ...
  var script$4 = {
    name: "CodemirrorTab",
    components: {
      Codemirror: __vue_component__$6,
    },
    props: {
      value: {
        type: [String, Number],
  ...
  var __vue_render__$5 = function () {
    ...
    return _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("Codemirror", {
          attrs: { code: _vm.simples[_vm.value].simple, mode: "text/javascript" },
        }),
      ],
      1
    )
  ...
  __vue_render__$5._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__$5 = "data-v-096cc92d";
    /* module identifier */
  ...
  __vue_render__$4._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__$4 = "data-v-08d377c8";
    /* module identifier */
  ...
  var __vue_render__$3 = function () {
    ...
    return _c(
      ...
      [
        _c("el-row", { staticClass: "url" }, [
          _c("span", { staticClass: "api-desc__label" }, [_vm._v("请求地址：")]),
          _vm._v(" "),
          _c("span", [_vm._v("https://" + _vm._s(_vm.data.uri))]),
          _vm._v(" "),
          _c(
            "span",
            {
            ...
            [_c("i", { staticClass: "el-icon-document-copy api-desc__copy" })]
          ),
        ]),
        _vm._v(" "),
        _c("el-row", { staticClass: "type" }, [
          _c("span", { staticClass: "api-desc__label" }, [_vm._v("请求方式：")]),
          _vm._v(" "),
          _c("span", [
            _vm._v(
              "\n      " +
                _vm._s(
                  _vm.toUpperCaseStr(
                    _vm.dict_json.getLabel(
                      "requestTypes",
                      _vm.data.requestType
                    ) || _vm.data.requestType
                  )
                ) +
                "\n    "
  ...
  __vue_render__$3._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__$3 = "data-v-718b6363";
    /* module identifier */
  ...
  __vue_render__$1._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__$1 = "data-v-00ca6346";
    /* module identifier */
  ...
  var script = {
    ...
    components: { Codemirror: __vue_component__$1, HttpSection: __vue_component__$4, RequestMeta: __vue_component__$2, CodemirrorTab: __vue_component__$5, HttpUri: __vue_component__$3 },
    data() {
      return {
        active: 0,
  ...
  var __vue_render__ = function () {
    ...
    return _c(
      ...
      { staticClass: "api-desc" },
      [
        _c("http-uri", { attrs: { data: _vm.httpbaseInfo } }),
        _vm._v(" "),
        _c("http-section", {
          attrs: { title: "请求参数(Params)", data: _vm.getList("2") },
          scopedSlots: _vm._u([
            {
              key: "default",
              fn: function (scope) {
                return [
                  scope.visible
                    ? _c("request-meta", { attrs: { data: scope.data } })
                    : _vm._e(),
                ]
              },
            },
        ...
        _vm._v(" "),
        _c("http-section", {
          attrs: { title: "请求参数(Headers)", data: _vm.getList("3") },
          scopedSlots: _vm._u([
            {
              key: "default",
              fn: function (scope) {
        ...
        _vm._v(" "),
        _c("http-section", {
          attrs: { title: "请求参数(Body)", data: _vm.httpbaseInfo.requestBody },
          scopedSlots: _vm._u([
            {
              key: "default",
              fn: function (scope) {
                return [
                  scope.visible
                    ? _c("Codemirror", {
                        attrs: { code: scope.data, mode: "text/javascript" },
                      })
                    : _vm._e(),
                ]
              },
        ...
        _vm._v(" "),
        _c("http-section", {
          attrs: { title: "响应参数(Params)", data: _vm.getList("4") },
          scopedSlots: _vm._u([
            {
              key: "default",
              fn: function (scope) {
        ...
        _vm._v(" "),
        _c("http-section", {
          attrs: { title: "响应参数(Headers)", data: _vm.getList("5") },
          scopedSlots: _vm._u([
            {
              key: "default",
              fn: function (scope) {
        ...
        _vm._v(" "),
        _c("http-section", {
          attrs: { title: "响应参数(Body)", data: _vm.httpbaseInfo.responseBody },
          scopedSlots: _vm._u([
            {
              key: "default",
              fn: function (scope) {
        ...
        _vm._v(" "),
        _c("http-section", {
          attrs: { title: "请求示例", data: _vm.supplierProductApiReqSimples },
          scopedSlots: _vm._u([
            {
              key: "default",
              fn: function (scope) {
        ...
        _vm._v(" "),
        _c("http-section", {
          attrs: { title: "返回示例", data: _vm.httpbaseInfo.responseSimple },
          scopedSlots: _vm._u([
            {
              key: "default",
              fn: function (scope) {
        ...
        _vm._v(" "),
        _c("http-section", {
          attrs: { title: "错误码定义", data: _vm.supplierProductApiRespCodes },
          scopedSlots: _vm._u([
            {
              key: "default",
              fn: function (scope) {
  ...
  var components = [__vue_component__$4, __vue_component__$2, __vue_component__$5, __vue_component__$3, __vue_component__];
  ...
  var index = {
    ...
    version: "1.0.0",
    // http description
    HttpSection: __vue_component__$4,
    RequestMeta: __vue_component__$2,
    CodemirrorTab: __vue_component__$5,
    HttpUri: __vue_component__$3,
    RequestDescription: __vue_component__
  };
